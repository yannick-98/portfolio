...
const Home = () => {
    return (
        <section id='home' className='flex flex-col items-center mx-auto space-y-8 
            min-h-[92vh]'>
            <img src="/src/img/Photo.png" alt="" className='pt-20 ' />
            ...
            <div className='flex flex-col gap-2 justify-center items-center'>
                <div className='flex items-center gap-1'>
                    <img src="/src/img/whatsapp-icon.png" alt="" className='w-4 h-4' />
                    <p>+34 613 030 850</p>
                </div>
                <div className='flex items-center gap-1'>
                    <img src="/src/img/email-icon.png" alt="" className='w-4 h-4' />
